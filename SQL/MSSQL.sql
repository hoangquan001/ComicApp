...
(11,N'Drama', N'Thể loại mang đến cho người xem những cảm xúc khác nhau: buồn bã, căng thẳng thậm chí là bi phẫ'),
(12,N'Đam Mỹ', N'Truyện tình cảm giữa nam và nam.'),
(13,N'Ecchi', N'Thường có những tình huống nhạy cảm nhằm lôi cuốn người xem'),
(14,N'Fantasy', N'Thể loại xuất phát từ trí tưởng tượng phong phú, từ pháp thuật đến thế giới trong mơ thậm chí là những câu chuyện thần tiê'),
...
(19,N'Josei', N'Thể loại của manga hay anime được sáng tác chủ yếu bởi phụ nữ cho những độc giả nữ từ 18 đến 30. Josei manga có thể miêu tả những lãng mạn thực tế , nhưng trái ngược với hầu hết các kiểu lãng mạn lí tưởng của Shoujo manga với cốt truyện rõ ràng, chín chắ'),
(20,N'Live actio', N'Truyện đã được chuyển thể thành phim'),
(21,N'Manga', N'Truyện tranh của Nhật Bả'),
...
(30,N'Psychological', N'Thể loại liên quan đến những vấn đề về tâm lý của nhân vật ( tâm thần bất ổn, điên cuồng ...),N'),
...
(34,N'Seine', N'Thể loại của manga thường nhằm vào những đối tượng nam 18 đến 30 tuổi, nhưng người xem có thể lớn tuổi hơn, với một vài bộ truyện nhắm đến các doanh nhân nam quá 40. Thể loại này có nhiều phong cách riêng biệt, nhưng thể loại này có những nét riêng biệt, thường được phân vào những phong cách nghệ thuật rộng hơn và phong phú hơn về chủ đề, có các loại từ mới mẻ tiên tiến đến khiêu dâm'),
...
(46,N'Tragedy', N'Thể loại chứa đựng những sự kiện mà dẫn đến kết cục là những mất mát hay sự rủi ro to lớ'),
(47,N'Trinh Thám', N'Các truyện có nội dung về các vụ án, các thám tử cảnh sát điều tra...'),
(48,N'Truyện sca', N'Các truyện đã phát hành tại VN được scan đăng online'),
(49,N'Truyện Màu', N'Tổng hợp truyện tranh màu, rõ, đẹp'),
(50,N'Webtoo', N'Là truyện tranh được đăng dài kỳ trên internet của Hàn Quốc chứ không xuất bản theo cách thông thường'),
